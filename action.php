...
if($received_data->action == 'genrunno')
{
    ...
    function insertSQL($instancetid, $userid, $expiredate, $serialno, $datecreate) {
        ...
        echo "Line 65, \$sqlInsert = $sqlInsert <br>";
    ...
    function generate_runno($j, $runno, $instanceid2) {
        ...
        for ($i = 1; $i < 2; $i++) {
            ...
            echo "\$instanceidcheck = $instanceidcheck , \$instanceid2 = $instanceid2,\$instanceid = $instanceid  <br>";
            ...
            echo "\$instanceidcheck2 = $instanceidcheck2 , \$instanceid2 = $instanceid2, \$instanceid = $instanceid<br>";
            echo "\$serial_no = $serial_no <br>";
            ...
            if(isset($instanceid)){
                if ($instanceid != $instanceidcheck2) {
                    $serialno = $serial_no;
                    $serialno++;
                    echo "in line 116 , before insertSQL, \$instanceid2 = $instanceid2, \$instanceid = $instanceid, \$serialno = $serialno<br>";
                    insertSQL($instanceid, $j, $expiredate, $serialno, $datecreate);
                } else {
                    echo "in line 119 else , before insertSQL, \instancetid = instancetid, \$serialno = $serialno<br>";
                    insertSQL($instanceid, $j, $expiredate, $serialno, $datecreate);
                }
            }
    ...
    //     }
    // }
    echo "in Line 143 isset of \$serialno <br>";
    $newrunno = $serialno;
    $newrunno++;
    echo "in Line 146  \$serialno = $serialno , \$newrunno = $newrunno <br>";
    if (isset($newrunno) ){
        if (isset($userid) ){
            $user = $userid;
        ...
        // echo "in Line 175 isset of \$serialno <br>";
        // $newrunno = $serialno;
        // $newrunno++;
    }    
    echo "instanceid = $getID1 , newrunno = $newrunno <br>";


    // $output = array(
    // 'message' => 'instanceid = $getID1 , newrunno = $newrunno  running no generated'
    // );
    $output = array(
